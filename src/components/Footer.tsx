...
<ul className="space-y-4 text-white/60 text-sm">
                  ...
                  <li><Link href="/about" className="hover:text-brand-accent transition-colors">About Practice</Link></li>
                  ...
                  <li><Link href="/register" className="hover:text-brand-accent transition-colors">Patient Registration</Link></li>
                  <li><Link href="/faq" className="hover:text-brand-accent transition-colors">FAQs</Link></li>
                  <li><Link href="/feedback" className="hover:text-brand-accent transition-colors">Rate Our Service</Link></li>
                </ul>
          </div>
              ...
              <div className="space-y-4 text-white/60 text-xs">
                ...
                <p>HPCSA Reg.: PT0134406</p>
                  <div className="pt-4">
                    ...
                    <a 
                      href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent("191 Boshoff Street, Pietermaritzburg, 3201")}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-brand-accent transition-colors block mb-1"
                    >
                      191 Boshoff Street, 3201
                    </a>
                  </div>
                  <div>
                    <p className="font-bold text-white mb-2">Hammarsdale</p>
                    <a 
                      href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent("6 Sibisi road Mpumalanga Township Hammersdale 3700")}`}
                      target="_blank"
                      rel="noopener noreferrer"
                  ...
                  <div className="pt-4 space-y-2">
                    ...
                    <a href="mailto:enquiries@mkhizephysio.co.za" className="hover:text-brand-accent transition-colors block break-all">enquiries@mkhizephysio.co.za</a>
                  </div>
                <div className="pt-6">
