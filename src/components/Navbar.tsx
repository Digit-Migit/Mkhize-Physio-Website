            ...
            <div className="px-4 py-6 flex flex-col gap-4">
              ...
              >
                ...
                <div className="flex flex-col gap-2 mt-4 pt-4 border-t text-sm text-gray-600">
                  <a href="tel:+27640012097" className="flex items-center gap-2 hover:text-brand-primary transition-colors">
                    <Phone size={16} className="text-brand-accent" />
                    <span>064 001 2097</span>
                  </a>
                  <a href="mailto:enquiries@mkhizephysio.co.za" className="flex items-center gap-2 hover:text-brand-primary transition-colors">
